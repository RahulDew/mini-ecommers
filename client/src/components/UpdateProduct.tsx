...
export default function UpdateProduct({ isNewProduct = true }: ProductProps) {
  ...
  return (
    <form
      ...
      className="flex items-start justify-center w-full  px-10 gap-10"
    >
      ...
      {/* product details */}
      <div className="space-y-3 text-black w-[400px]">
        {/* input description */}
        <div className="flex flex-col justify-start items-start">
          <label className="font-semibold text-sm leading-6">Description</label>
          <div className="mt-2 w-full">
            <textarea
              id="description"
