  ...
  return (
    <div className="w-full min-h-screen text-center px-5 md:px-10 flex justify-center lg:px-16 py-6 duration-300">
      <div className="sm:mx-auto w-full sm:max-w-sm">
        ...
        <div className="mt-5 flex justify-center items-center border-2 border-black w-52 m-auto rounded-md">
          <button
            onClick={() => setRole("admin")}
            className={`${
              role === "admin" && "bg-black text-white"
            } hover:bg-indigo-600 text-md font-semibold rounded-sm text-black hover:text-white p-2 w-1/2 text-center duration-300`}
          >
            as admin
          </button>
          <button
              ...
              <div className="mt-2 w-full">
                <input
                  ...
                  {...register("confirmPassword", {
                    required: "Password confirmation is also required",
                    validate: (value) =>
